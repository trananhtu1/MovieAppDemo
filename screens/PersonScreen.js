...
export default function PersonScreen() {
    ...
    const getPersonDetails = async id=>{
        ...
        console.log('đã lấy thông tin diễn viên');
        setLoading(false);
        if(data) {
            setPerson(data);
        }
    ...
    const getPersonMovies = async id=>{
        ...
        console.log('đã lấy phim tương tự do diễn viên này tham gia')
        if(data && data.cast){
            ...
            loading? (
                ...
                <View>
                    ...
                    <View className="mx-3 p-4 mt-6 flex-row justify-between items-center bg-neutral-700 rounded-full ">
                        ...
                        <View className="border-r-2 border-r-neutral-400 px-2 items-center">
                            <Text className="text-white font-semibold">Thể Loại</Text>
                            <Text className="text-neutral-300 text-sm">
                        ...
                        <View className="px-2 items-center">
                            <Text className="text-white font-semibold">Yêu Thích</Text>
                            <Text className="text-neutral-300 text-sm">
                    ...
                    {/* Phim khác diễn viên này tham gia */}
                    { person?.id && personMovies.length>0 && <MovieList title="Phim Khác" hideSeeAll={true} data={personMovies} /> }
